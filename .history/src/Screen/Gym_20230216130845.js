  ...
  return (
    <>
      ...
      <div className="NewProductS">
        <div className="item">
          <div className="imgeOuter">
            <img src={img4} alt="" onClick={() => NavigationHandler("/single")}  style={{width : '40%'}}/>
          </div>
          <p>
      ...
      <div className="NewProductS">
        ...
        <div className="item">
          <div className="imgeOuter">
            <img src={img10} alt=""  onClick={() => NavigationHandler("/single")} style={{width : '50%'}} />
          </div>
          <p>
            Meta Quest 2 — Advanced All-In-One Virtual Reality
            <br />
