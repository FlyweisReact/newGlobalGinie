      ...
      <div className="NewProductS">
        <div className="item">
          <div className="imgeOuter">
            <img src={Cam} alt="" style={{ width: "50%" }} />
          </div>
          <p>
        ...
        <div className="item">
          <div className="imgeOuter">
            <img src={Carioke} alt="" style={{ width: "50%" }} />
          </div>
          <p>
            Meta Quest 2 — Advanced All-In-One Virtual Reality
            <br />
        ...
        <div className="item">
          <div className="imgeOuter">
            <img src={Watch} alt="" style={{ width: "50%" }} />
          </div>
          <p>
            Meta Quest 2 — Advanced All-In-One Virtual Reality
            <br />
        ...
        <div className="item">
          <div className="imgeOuter">
            <img src={Bud} alt="" style={{ width: "50%" }} />
          </div>
          <p>
            Meta Quest 2 — Advanced All-In-One Virtual Reality
            <br />
