...
const Tech = () => {
  ...
  return (
    <>
      ...
      <div className="child">
        <div className="month" style={{ minWidth: "200px" }} >MEN</div>
        <div className="month" style={{ minWidth: "200px" }}>WOMEN</div>
        <div className="month" style={{ minWidth: "200px" }}>KIDS</div>
      </div>
      ...
      <div className="NewProductS">
        <div className="item">
          <div className="imgeOuter">
            <img src={img17} alt="" style={{ width: "50%" }}  onClick={() => NavigationHandler("/single")}     onClick={() => NavigationHandler("/single")}/>
          </div>
          <p>
            Meta Quest 2 — Advanced All-In-One Virtual Reality
            <br />
