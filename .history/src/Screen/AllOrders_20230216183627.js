  ...
  return (
    <>
      ...
      <div className="MyOrderPlaced">
        <h2>
          {" "}
          <span style={{ fontWeight: "900" }}>18 orders </span> placed in{" "}
        </h2>
        <select>
      ...
      <hr className="myHr" style={{ border : "2px solid black" , maxWidth : '1400px' , margin : 'auto' , marginTop : '1%'}} />

      {/* ------------------------------------------------------ */}

      <h2 className="OrderSum">View Order Summary</h2>
      <hr cclassName="myHr" style={{ border : "2px solid black" , maxWidth : '1400px' , margin : 'auto' , marginTop : '1%'}} />
